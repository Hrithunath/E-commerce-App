...
import 'package:e_commerce_app/presentation/Widget/Home/custom_appbar.dart';
import 'package:e_commerce_app/presentation/Widget/Home/custom_primary_header_container.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              CustomAppbar( 
                ...
                subtitle: SizedBox( width:double.infinity,
                child:  TextCustom(text: "Hrithunath",
        ...
        String imageUrl = banner['imageurl'] ?? 'https://via.placeholder.com/350x330';
